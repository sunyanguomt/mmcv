...
void ball_query_forward_impl(int b, int n, int m, float min_radius,
                             ...
                             const Tensor new_xyz, const Tensor xyz,
                             Tensor idx);
REGISTER_DEVICE_IMPL(ball_query_forward_impl, PrivateUse1, ball_query_forward_cuda);
...
void bbox_overlaps_impl(const Tensor bboxes1, const Tensor bboxes2, Tensor ious,
                        const int mode, const bool aligned, const int offset);
REGISTER_DEVICE_IMPL(bbox_overlaps_impl, PrivateUse1, bbox_overlaps_cuda);
...
void box_iou_rotated_impl(const Tensor boxes1, const Tensor boxes2, Tensor ious,
                          const int mode_flag, const bool aligned);
REGISTER_DEVICE_IMPL(box_iou_rotated_impl, PrivateUse1, box_iou_rotated_cuda);
...
REGISTER_DEVICE_IMPL(carafe_forward_impl, PrivateUse1, carafe_forward_cuda);
REGISTER_DEVICE_IMPL(carafe_backward_impl, PrivateUse1, carafe_backward_cuda);
...
REGISTER_DEVICE_IMPL(correlation_forward_impl, PrivateUse1, correlation_forward_cuda);
...
REGISTER_DEVICE_IMPL(deformable_im2col_impl, PrivateUse1, deformable_im2col_cuda);
REGISTER_DEVICE_IMPL(deformable_col2im_impl, PrivateUse1, deformable_col2im_cuda);
...
REGISTER_DEVICE_IMPL(iou3d_boxes_iou_bev_forward_impl, PrivateUse1,
                     iou3d_boxes_iou_bev_forward_cuda);
REGISTER_DEVICE_IMPL(iou3d_nms3d_forward_impl, PrivateUse1, iou3d_nms3d_forward_cuda);
...
void knn_forward_impl(int b, int n, int m, int nsample, const Tensor xyz,
                      const Tensor new_xyz, Tensor idx, Tensor dist2);
REGISTER_DEVICE_IMPL(knn_forward_impl, PrivateUse1, knn_forward_cuda);
...
REGISTER_DEVICE_IMPL(nms_impl, PrivateUse1, nms_cuda);
...
void psamask_backward_impl(const int psa_type, const Tensor grad_output,
                           ...
                           const int h_mask, const int w_mask,
                           const int half_h_mask, const int half_w_mask);
REGISTER_DEVICE_IMPL(psamask_forward_impl, PrivateUse1, psamask_forward_cuda);
REGISTER_DEVICE_IMPL(psamask_backward_impl, PrivateUse1, psamask_backward_cuda);
...
REGISTER_DEVICE_IMPL(roi_align_forward_impl, PrivateUse1, roi_align_forward_cuda);
REGISTER_DEVICE_IMPL(roi_align_backward_impl, PrivateUse1, roi_align_backward_cuda);
...
void roi_pool_backward_impl(Tensor grad_output, Tensor rois, Tensor argmax,
                            Tensor grad_input, int pooled_height,
                            int pooled_width, float spatial_scale);
REGISTER_DEVICE_IMPL(roi_pool_forward_impl, PrivateUse1, roi_pool_forward_cuda);
REGISTER_DEVICE_IMPL(roi_pool_backward_impl, PrivateUse1, roi_pool_backward_cuda);
...
REGISTER_DEVICE_IMPL(sync_bn_forward_var_impl, PrivateUse1, sync_bn_forward_var_cuda);
...
void three_nn_forward_impl(int b, int n, int m, const Tensor unknown,
                           const Tensor known, Tensor dist2, Tensor idx);
REGISTER_DEVICE_IMPL(three_nn_forward_impl, PrivateUse1, three_nn_forward_cuda);
...
void tin_shift_backward_impl(Tensor grad_output, Tensor shift,
                             Tensor grad_input);
REGISTER_DEVICE_IMPL(tin_shift_forward_impl, PrivateUse1, tin_shift_forward_cuda);
REGISTER_DEVICE_IMPL(tin_shift_backward_impl, PrivateUse1, tin_shift_backward_cuda);
...
REGISTER_DEVICE_IMPL(indice_conv_forward_impl, PrivateUse1, indice_conv_forward_cuda);
...
REGISTER_DEVICE_IMPL(min_area_polygons_impl, PrivateUse1, min_area_polygons_cuda);
...
REGISTER_DEVICE_IMPL(convex_iou_impl, PrivateUse1, convex_iou_cuda);
REGISTER_DEVICE_IMPL(convex_giou_impl, PrivateUse1, convex_giou_cuda);
...
void prroi_pool_coor_backward_impl(Tensor output, Tensor grad_output,
                                   ...
                                   int pooled_height, int pooled_width,
                                   float spatial_scale);
REGISTER_DEVICE_IMPL(prroi_pool_forward_impl, PrivateUse1, prroi_pool_forward_cuda);
REGISTER_DEVICE_IMPL(prroi_pool_backward_impl, PrivateUse1, prroi_pool_backward_cuda);
